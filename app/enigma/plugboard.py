class Plugboard:
    """
    The Plugboard provided the opportunity to swap any of the 26 letters in the alpabet. Providing a further layer of encryption.
    This class requires a list of string pairs i.e. ["AF", "WZ"].
    Then swaps the first char with the second.
    """
